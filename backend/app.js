...
db.init_db().then(() => {
	...
	db.add_service("microplastics", "yummy", "micro corp", ["https://microplastics.rit.edu/", "https://website.com/", "https://localhost/"]).then(() => db.get_services_light("trash dude").then(console.log));
	}
});
